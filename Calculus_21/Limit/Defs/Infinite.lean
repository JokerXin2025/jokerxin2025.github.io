...
section
variable (A : Sequence) (F : Function) (x₀ : ℝ)
...
@theorem SeqLimitPosInfty.Congr {B : Sequence}
...
@theorem SeqLimitNegInfty.Congr {B : Sequence}
...
@theorem SeqLimitInfty.Congr {B : Sequence}
...
private theorem infiniteLimitCongr
    {S : ℝ → Set ℝ} {p : ℝ → Prop} {q : ℝ → ℝ → Prop} {G : Function}
...
@theorem FuncLimitPosInfty.Congr {G : Function}
...
@theorem FuncLimitNegInfty.Congr {G : Function}
...
@theorem FuncLimitInfty.Congr {G : Function}
...
@theorem LeftLimitPosInfty.Congr {G : Function}
...
@theorem LeftLimitNegInfty.Congr {G : Function}
...
@theorem LeftLimitInfty.Congr {G : Function}
...
@theorem RightLimitPosInfty.Congr {G : Function}
...
@theorem RightLimitNegInfty.Congr {G : Function}
...
@theorem RightLimitInfty.Congr {G : Function}
...
@theorem PosInftyLimitPosInfty.Congr {G : Function}
...
@theorem PosInftyLimitNegInfty.Congr {G : Function}
...
@theorem PosInftyLimitInfty.Congr {G : Function}
...
@theorem NegInftyLimitPosInfty.Congr {G : Function}
...
@theorem NegInftyLimitNegInfty.Congr {G : Function}
...
@theorem NegInftyLimitInfty.Congr {G : Function}
...
@theorem InftyLimitPosInfty.Congr {G : Function}
...
@theorem InftyLimitNegInfty.Congr {G : Function}
...
@theorem InftyLimitInfty.Congr {G : Function}

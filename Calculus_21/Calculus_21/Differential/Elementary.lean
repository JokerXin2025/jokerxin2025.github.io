...
/-- Power RFunction's Derivative for `n : ℤ` (Expression)
    - Junk value `0 ^ 0 = 1` will be used if `n = 1 ∧ x₀ = 0`. -/
...
/-- Power RFunction's Left Derivative for `n : ℤ` (Expression)
    - Junk value `0 ^ 0 = 1` will be used if `n = 1 ∧ x₀ = 0`. -/
...
/-- Power RFunction's Right Derivative for `n : ℤ` (Expression)
    - Junk value `0 ^ 0 = 1` will be used if `n = 1 ∧ x₀ = 0`. -/

...
theorem LeftLimit.L'Hospital_x₀_zero {F G : RFunction} {x₀ L : ℝ}
...
theorem RightLimit.L'Hospital_x₀_zero {F G : RFunction} {x₀ L : ℝ}
...
theorem FuncLimit.L'Hospital_x₀_zero {F G : RFunction} {x₀ L : ℝ}

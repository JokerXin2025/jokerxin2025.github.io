...
/-- Derivative -/
def Deriv (F : Function) (x₀ D : ℝ) : Prop :=
...
def NthDeriv (n : ℕ) (F : Function) (x₀ D : ℝ) : Prop :=
  match n with
...
/-- Left Derivative -/
def LeftDeriv (F : Function) (x₀ D : ℝ) : Prop :=
...
/-- Right Derivative -/
def RightDeriv (F : Function) (x₀ D : ℝ) : Prop :=
...
@theorem NthDeriv_Unique {n : ℕ} {F : Function} {x₀ D₁ D₂ : ℝ}
